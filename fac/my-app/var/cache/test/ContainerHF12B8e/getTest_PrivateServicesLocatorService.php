...
return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\DataFixtures\\AppFixtures' => function () {
    return ($this->privates['App\DataFixtures\AppFixtures'] ?? $this->privates['App\DataFixtures\AppFixtures'] = new \App\DataFixtures\AppFixtures());
}, 'App\\DataFixtures\\ORM\\Fixtures' => function () {
    return ($this->privates['App\DataFixtures\ORM\Fixtures'] ?? $this->privates['App\DataFixtures\ORM\Fixtures'] = new \App\DataFixtures\ORM\Fixtures());
}, 'App\\Form\\AuthorFormType' => function () {
    return ($this->privates['App\Form\AuthorFormType'] ?? $this->privates['App\Form\AuthorFormType'] = new \App\Form\AuthorFormType());
}, 'App\\Repository\\AuthorRepository' => function () {
    return ($this->privates['App\Repository\AuthorRepository'] ?? $this->load('getAuthorRepositoryService.php'));
...
}, 'form.type_extension.form.transformation_failure_handling' => function () {
    return ($this->privates['form.type_extension.form.transformation_failure_handling'] ?? $this->load('getForm_TypeExtension_Form_TransformationFailureHandlingService.php'));
    ...
    return ($this->privates['.service_locator.aweAo1N'] ?? $this->load('get_ServiceLocator_AweAo1NService.php'));
