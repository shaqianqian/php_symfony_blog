...
return $this->privates['twig.template_cache_warmer'] = new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer(($this->privates['.service_locator.UEpceA5'] ?? $this->load('get_ServiceLocator_UEpceA5Service.php'))->withContext('twig.template_cache_warmer', $this), ($this->privates['twig.template_iterator'] ?? $this->load('getTwig_TemplateIteratorService.php')));
